...
const pkg = {
  name: 'isomorphic-git',
  version: '0.70.0',
  agent: 'git/isomorphic-git@0.70.0'
};
...
export { E, STAGE, TREE, WORKDIR, add, addRemote, annotatedTag, branch, checkout, clone, commit, config, cores, currentBranch, deleteBranch, deleteRef, deleteRemote, deleteTag, expandOid$1 as expandOid, expandRef, fastCheckout, fetch, findMergeBase, findRoot, getRemoteInfo, hashBlob, indexPack, init, isDescendent, listBranches, listFiles, listRemotes, listTags, log$1 as log, merge, packObjects, plugins, pull, push, readObject$1 as readObject, remove, resetIndex, resolveRef, sign, status, statusMatrix, tag, utils, verify, version, walkBeta1, walkBeta2, writeObject$1 as writeObject, writeRef };
